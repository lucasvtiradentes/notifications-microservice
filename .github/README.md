...
&nbsp;&nbsp;&nbsp;✔️ microservice (kafka consumer) that listens kafka-producers natifications;<br>
&nbsp;&nbsp;&nbsp;✔️ stores the messages in a prisma database;<br>
&nbsp;&nbsp;&nbsp;✔️ nestjs backend server, with some routes to modifiy the messages;<br>
&nbsp;&nbsp;&nbsp;✔️ lots of units tests, using jest;<br>
&nbsp;&nbsp;&nbsp;✔️ implementation of factory and repostiroy design patterns.<br>
